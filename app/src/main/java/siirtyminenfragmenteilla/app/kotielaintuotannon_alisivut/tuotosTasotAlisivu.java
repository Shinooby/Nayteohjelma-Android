...
public class tuotosTasotAlisivu extends ActionBarActivity {

    private String tableName = "tableName";
    private  String ID = "ID";
    private  String IDValue;

    EditText viimeVuosienTuotostasot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setTheme(R.style.BlackTheme);
        setContentView(R.layout.activity_tuotos_tasot_alisivu);

        setCredentialsFromPreferences();

        viimeVuosienTuotostasot = (EditText)findViewById(R.id.viimeVuosienTuotostasotLayout);

        new JSONParse().execute();

        viimeVuosienTuotostasot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String attribute = "attribute";
                String currentValue = viimeVuosienTuotostasot.getText().toString();
                callDialogForInput("Selvitä viime vuosien tuotostasot ja niiden kehitys",
                        currentValue, viimeVuosienTuotostasot, attribute, 1000);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.tuotos_tasot_alisivu, menu);
        return true;
    }
    ...
    private class JSONParse extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... strings) {
            ...
            String itemIDforJSON = "productionlevels";
            try {
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                if (json != null) {
                    ...
                    saveState = "update";
                  viimeVuosienTuotostasot.setText(json.getString("plDev"));
                }
                else {
                    Log.d("Json on tyhjä", "...");
                    saveState = "insert";
