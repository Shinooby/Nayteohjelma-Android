...
public class YllapitoJaKehittaminen extends ActionBarActivity {

    EditText tuotannonTarkkailu;
    EditText kirjanpidonHoito;
    EditText yrityksenKehitys;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setTheme(R.style.BlackTheme);
        setContentView(R.layout.activity_yllapito_ja_kehittaminen);

        setCredentialsFromPreferences();

        tuotannonTarkkailu = (EditText)findViewById(R.id.tuotannonTarkkailuEditText);
        kirjanpidonHoito = (EditText)findViewById(R.id.kirjanpidonHoitoEditText);
        yrityksenKehitys= (EditText)findViewById(R.id.yrityksenKehittaminenEditText);

        tuotannonTarkkailu.setOnClickListener(onClickListener);
        kirjanpidonHoito.setOnClickListener(onClickListener);
        yrityksenKehitys.setOnClickListener(onClickListener);
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case (R.id.tuotannonTarkkailuEditText):
                     attribute = "currentAttribute";
                     currentValue = tuotannonTarkkailu.getText().toString();
                    callDialogForInput("Miten yrityksessä tarkkaillaan tuotantoa ja kuinka saatuja tietoja " +
                                    "käytetään hyväksi?",
                            currentValue, tuotannonTarkkailu, attribute, 1000);
                    break;
                case (R.id.kirjanpidonHoitoEditText):
                    attribute = "currentAttribute";
                    currentValue = kirjanpidonHoito.getText().toString();
                    callDialogForInput("Kuka hoitaa yrityksen kirjanpidon ja miten kirjanpitoa hyödynnetään " +
                                    "päätöksenteossa?",
                            currentValue, kirjanpidonHoito, attribute, 1000);
                    break;
                case (R.id.yrityksenKehittaminenEditText):
                    attribute = "currentAttribute";
                    currentValue = yrityksenKehitys.getText().toString();
                    callDialogForInput("Miten yrittäjä kehittää yritystä ja omaa osaamistaan?",
                            currentValue, yrityksenKehitys, attribute, 1000);
                    break;
            }
        }
    };
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.yllapito_ja_kehittaminen, menu);
        return true;
    }
    ...
    private class JSONParse extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... strings) {
            ...
            String itemIDforJSON = "firmdevelopment";
            try {
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                if (json != null) {
                    ...
                    saveState = "update";
                    tuotannonTarkkailu.setText(json.getString("fdMonitoring"));
                     kirjanpidonHoito.setText(json.getString("fdAccounting"));
                     yrityksenKehitys.setText(json.getString("fdFirmDeveloper"));
                }
                else {
                    Log.d("Json on tyhjä", "...");
                    saveState = "insert";
